        ...
        <div className="a-left">
          <div>
            ...
            <p>
              ...
              responsive and user-friendly websites. With 1 year of experience,
              I specialize in front-end and back-end development, focusing on
              performance optimization and SEO. Let's collaborate on your next
              project. Reach out always.
            </p>
          </div>
          <button className="button a-button">
            Download CV <box-icon type="solid" name="cloud-download"></box-icon>
          </button>
        </div>
